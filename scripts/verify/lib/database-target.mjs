...
export const SQL_BACKED_DATABASE_ENV_KEYS = [
  ...
  "OPERATIONAL_CYCLES_TEST_DATABASE_URL",
  "JOB_FLOW_TEST_DATABASE_URL",
  "OPERATIONAL_EVIDENCE_TEST_DATABASE_URL",
  "CANONICAL_LOGS_TEST_DATABASE_URL",
  "ASSET_OPERATIONS_TEST_DATABASE_URL",
  "DEPARTMENT_WORK_TEST_DATABASE_URL",
  "BULK_IMPORT_TEST_DATABASE_URL",
];
