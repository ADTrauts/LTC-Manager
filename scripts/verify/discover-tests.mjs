...
export const SQL_BACKED_TEST_FILES = [
  ...
  "src/lib/canonical-logs/phase-3-canonical-logs.test.ts",
  ...
  "src/lib/department-teams/department-teams.db.test.ts",
  "src/lib/employee-membership/employee-membership.db.test.ts",
