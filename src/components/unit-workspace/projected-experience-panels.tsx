import type { UnitWorkspaceProjectionView } from "@/lib/unit-workspace/projection";
                ...
                {area.experiences.map((experience) => (
                  ...
                  >
                    ...
                    <p className="mt-3 text-xs text-zinc-500">
                      Runtime body for this Experience will attach in a later
                      wave. Density: {experience.density}.
                    </p>
                  </article>
                ))}
              </div>
