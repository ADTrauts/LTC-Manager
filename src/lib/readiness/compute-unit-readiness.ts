...
type OptionalSignalKey =
  ...
  | "primaryCriticalOutOfServiceName"
  | "importantOutOfServiceCount"
  | "primaryImportantOutOfServiceName"
  | "importantOutOfServiceAddressedCount"
  | "importantOutOfServiceUnaddressedCount"
  | "routineOutOfServiceCount"
  | "overdueCriticalPmCount"
  | "primaryOverdueCriticalPmName"
  | "overdueImportantPmCount"
  | "overdueRoutinePmCount"
  | "dueTodayPmScheduleCount"
  | "pmDueTodayUnderwayElevatedCount"
