...
const BASELINE_ARCHETYPES: Record<BaselineDepartmentKey, BaselineArchetypePlan[]> = {
  DIETARY: [
    ...
    },
    {
      key: "main_kitchen",
      name: "Main Kitchen",
      description: "Central production kitchen supporting downstream service.",
      sortOrder: 22,
      experienceKeys: [
        "PRODUCTION",
        "RECIPES",
    ...
    },
    {
      key: "retail",
      name: "Retail",
      description: "Retail or cafe point of sale.",
      sortOrder: 25,
      experienceKeys: ["MENUS", "MEAL_SERVICE", "SATISFACTION", "EQUIPMENT", "CLEANING_LISTS"],
    },
    {
      key: "dining_room",
      name: "Dining Room",
