...
function dateHref(date: Date) {
  return `/staffing/legacy?date=${toIsoDate(date)}`;
}
  ...
  return (
    <section className="space-y-6">
      ...
      <header className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight text-zinc-900">Legacy unit staffing</h1>
          <p className="mt-1 max-w-3xl text-sm text-zinc-600">
            Compatibility view for Unit and meal-slot schedule rows. Prefer the Department Schedule for
            clock-time Shifts. Servery locations still capture breakfast, lunch, and dinner service slots.
          </p>
          <div className="mt-3 flex flex-wrap items-center gap-2">
            ...
            <Link href="/staffing/legacy" className="rounded-md border border-zinc-300 bg-white px-3 py-1.5 text-sm text-zinc-800 hover:bg-zinc-50">
              Today
            </Link>
