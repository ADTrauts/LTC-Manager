...
export async function LegacyReport({
  facilityId,
  params,
}: {
  facilityId: string;
  ...
  const activeFilterCount = [
    Boolean(params.start),
    Boolean(params.end),
    Boolean(unitIdFilter),
    Boolean(repairStatusFilter),
  ...
  return (
    <div className="space-y-6" data-testid="legacy-report">
      ...
      >
        <form className="grid gap-3 md:grid-cols-2 xl:grid-cols-5" method="get">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              href="/reports?view=legacy"
              className="app-button border border-zinc-300 hover:bg-zinc-100"
            >
              Reset
            </Link>
          </div>
      ...
      <section className="grid gap-4 xl:grid-cols-2">
        <article className="app-card">
          <h2 className="text-lg font-semibold text-zinc-900">Log Completion by Unit (legacy)</h2>
          <div className="mt-3 overflow-x-auto">
            <table className="min-w-full text-left text-sm">
              <thead>
                <tr className="border-b border-zinc-200 text-zinc-500">
                  <th className="py-2 pr-3">Unit</th>
                  <th className="py-2 pr-3">Expected (legacy)</th>
                  <th className="py-2 pr-3">Completed</th>
                  <th className="py-2 pr-3">Missing (legacy)</th>
                </tr>
              </thead>
              <tbody>
      ...
      <section className="app-card">
        <h2 className="text-lg font-semibold text-zinc-900">Staffing Coverage by Day (legacy)</h2>
        <div className="mt-3 overflow-x-auto">
          <table className="min-w-full text-left text-sm">
            <thead>
              <tr className="border-b border-zinc-200 text-zinc-500">
                ...
                <th className="py-2 pr-3">Effective Coverage (legacy)</th>
              </tr>
            </thead>
            <tbody>
