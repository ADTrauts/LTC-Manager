      ...
      <header className="space-y-3 border-b border-zinc-200 pb-5">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <h1 className="mt-1 text-2xl font-semibold tracking-tight text-zinc-900">Handoffs</h1>
            <p className="mt-1 max-w-2xl text-sm text-zinc-600">
              Read-only rollup of what may carry between teams — failed checks, repairs, call-downs, and coverage gaps.
